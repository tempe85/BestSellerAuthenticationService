...
namespace BestSeller.Authentication.Service
{
    public class ProfileService : IProfileService
    {
        ...
        private readonly IUserClaimsPrincipalFactory<BestSellerUser> _claimsFactory;

        protected readonly ILogger<ProfileService> _logger;

        public ProfileService(UserManager<BestSellerUser> userManager, IUserClaimsPrincipalFactory<BestSellerUser> claimsFactory, ILogger<ProfileService> logger)
        {
